...
const SimilarCourts = () => {
  ...
  useEffect(() => {
    const fetchCourts = async () => {
      try {
        setLoading(true);
        const response = await courtService.getList(currentPage, pageSize);
        ...
        if (response.isSuccessed) {
          ...
          const courtsData = (response.resultObj?.items || []).map((court) => ({
            ...
            reviewCount: court.ratingSummaryModelView.totalReviewerCount,
          }));
      ...
      <div className="courts-row">
        {displayCourts.map((court) => (
          <div
            ...
            style={{ cursor: "pointer" }} // con trỏ chuột đổi để người dùng biết có thể click
          >
