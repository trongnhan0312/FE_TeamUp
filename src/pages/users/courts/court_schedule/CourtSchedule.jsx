    ...
    <div className="court-schedule">
      <div className="schedule-container">
        <div className="schedule-header">
          <div className="week-selector">
            <div className="date-range">
              {formatDate(currentWeek[0])} - {formatDate(currentWeek[6])} tháng{" "}
        ...
        <div className="schedule-grid">
          ...
          {currentWeek.map((date, dateIndex) => {
            const dayName = ["Hai", "Ba", "Tư", "Năm", "Sáu", "Bảy", "CN"][
              dateIndex
            ];
            ...
            return (
              <div key={`date-${dateIndex}`} className="day-column">
                ...
                {timeSlots.map((time, timeIndex) => {
                  ...
                  const isSelectedEnd =
                    isMultiBooking && isSelectedBookingSlot(date, time, "end");
      ...
      <div className="calendar-panel">
            ...
            {calendarDays.map((day, index) => (
              <div
                ...
                onClick={() => {
                  ...
                  if (day.date < currentWeek[0] || day.date > currentWeek[6]) {
        ...
        <div className="time-selection-guide">
          <p>{isMultiBooking ? "Cách đặt sân (Admin):" : "Cách đặt sân:"}</p>
          {isMultiBooking ? (
            <ol>
              ...
              <li>
                Chọn một ô xanh lá khác để đặt <strong>giờ kết thúc</strong> cho
                booking đó
              </li>
              <li>
                Có thể tiếp tục chọn <strong>nhiều khung giờ khác</strong> trên
                cùng ngày hoặc <strong>ngày khác</strong>
              </li>
              <li>
                Sử dụng nút <strong>Xóa</strong> để bỏ bất kỳ booking nào không
                mong muốn
              </li>
            </ol>
          ) : (
