...
const CoachProfile = () => {
        ...
        const fetchCoachData = async () => {
            try {
                ...
                if (response.isSuccessed) {
                    ...
                    setError(response.message || "Không thể lấy thông tin huấn luyện viên");
                }
            } catch (err) {
    ...
    if (loading) {
        return <div className="coach-profile-loading">Đang tải thông tin huấn luyện viên...</div>;
    }
    ...
    if (!coach) {
        return <div className="coach-profile-not-found">Không tìm thấy thông tin huấn luyện viên</div>;
    }
                ...
                <div className="coach-profile-right">
                    <div className="coach-details-section">
                        ...
                        <div className="detail-row">
                            ...
                            <div className="detail-content">
                                <strong>Học phí:</strong> {formatPrice(coach.pricePerSession)} VNĐ/buổi
                            </div>
                        </div>
                        ...
                        <div className="training-content-section">
                            ...
                            <ul className="training-list">
                                <li className="training-item">
                                    ...
                                    <span>Thể lực & tốc độ: Bài tập tăng cường sức bền, phản xạ nhanh</span>
                                </li>
                                <li className="training-item">
                                    <FaCheckCircle className="check-icon" />
                                    <span>Chiến thuật thi đấu: Đọc trận đấu, chơi theo đội hình phù hợp</span>
                                </li>
                                <li className="training-item">
                                    <FaCheckCircle className="check-icon" />
                                    <span>Cải thiện vị trí thi đấu: Hỗ trợ luyện tập chuyên sâu theo vị trí sở trường</span>
                                </li>
                                <li className="training-item">
                                    <FaCheckCircle className="check-icon" />
                                    <span>Huấn luyện cá nhân hoặc nhóm nhỏ: Đảm bảo hiệu quả tối đa cho học viên</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="contact-section">
                            <p className="contact-message">
                                👋 {coach.contactMessage || "Liên hệ ngay để đặt lịch học và nâng cao kỹ năng của bạn!"}
                            </p>
                            <div className="contact-buttons">
                                <button className="contact-button">Liên hệ</button>
                                <button className="contact-button schedule-button">Đặt lịch</button>
                            </div>
                        </div>
                    </div>
                </div>
